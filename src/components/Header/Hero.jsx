      ...
      >
        <div>
          ...
          <div className="text-[30px] md:text-[35px] flex justify-center gap-5   items-center md:mt-10 mt-5 md:gap-12 cursor-pointer mb-20  ">
            <Link
              target="_blank"
              to="https://www.linkedin.com/in/sahilejhalak95/"
            >
              {" "}
            ...
            <Link
              target="_blank"
              to="https://www.leetcode.com/sahil_ansari98/"
            >
              <SiLeetcode className="mx-2 hover:translate-y-[-2px] hover:cursor-pointer transition-all ease-in duration-100 -md:mx-0 -md:my-[1px]" />
            </Link>
          </div>
        </div>
